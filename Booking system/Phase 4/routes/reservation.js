...
export async function handleReservationForm(req) {
    ...
    <body class="bg-gray-100 text-gray-900">
        <div class="container mx-auto p-4">
            <div class="bg-white shadow-md rounded-lg p-6 mt-6 max-w-xl mx-auto">
                <h1 class="text-2xl font-bold mb-4 text-center">Manage reservation</h1>
                <form action="/reservation" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="reserver_token" id="reserver_token" maxlength="36" required>
                    </div>

                    <!-- Resource ID -->
                    <div class="mb-4">
                        <label for="resource_id" class="block text-sm font-medium text-gray-700 font-bold">Resource</label>
                        <select name="resource_id" id="resource_id" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </select>
                    </div>
