...
export async function handleIndex(req) {
    ...
    loggedHtml += `<h1 class="text-2xl font-bold mb-4">Welcome to the Booking system
                    <a href="/account" class="inline-block bg-blue-200 text-black py-2 px-2 rounded hover:bg-blue300">${session.username}</a></h1>
                    <h2 class="text-xl font-bold mb-4">Your role is ${session.role}</h2>`;
